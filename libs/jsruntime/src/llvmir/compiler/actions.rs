...
// template: libs/jsruntime/src/llvmir/compiler/actions.rs.njk
...
pub enum Action {
    Undefined,
    Nop,
    Invoke(fn(&mut Compiler) -> Result<(), String>, &'static str),
}

#[rustfmt::skip]
pub static ACTIONS: [Action; 2080] = [
    // Script -> (empty)
    Action::Undefined,
    // Script -> ScriptBody
    Action::Nop,
    ...
    Action::Invoke(Compiler::handle_statement, "handle_statement"),
    ...
    Action::Invoke(Compiler::handle_expression_statement, "handle_expression_statement"),
