...
export * as http from 'https://deno.land/std@0.95.0/http/mod.ts';
export * as http_file_server from 'https://deno.land/std@0.95.0/http/file_server.ts';
export * as path from 'https://deno.land/std@0.95.0/path/mod.ts';
export * as testing from 'https://deno.land/std@0.95.0/testing/asserts.ts';
export * as ws from 'https://deno.land/std@0.95.0/ws/mod.ts';
