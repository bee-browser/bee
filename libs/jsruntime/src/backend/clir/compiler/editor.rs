...
impl<'a> Editor<'a> {
    ...
    pub fn put_store_outer_to_callee_context(&mut self) {
        ...
        self.builder
            .ins()
            .stack_store(self.addr_type, caller, self.callee_context, OFFSET);
    }
    ...
    pub fn put_store_flags_to_callee_context(&mut self, flags: ExecContextFlags) {
        ...
        self.builder
            .ins()
            .stack_store(self.addr_type, flags, self.callee_context, OFFSET);
    }
    ...
    pub fn put_store_depth_to_callee_context(&mut self) {
        ...
        self.builder
            .ins()
            .stack_store(self.addr_type, depth, self.callee_context, OFFSET);
    }
    ...
    pub fn put_store_argc_to_callee_context(&mut self, argc: u16) {
        ...
        self.builder
            .ins()
            .stack_store(self.addr_type, argc, self.callee_context, OFFSET);
    }
    ...
    pub fn put_store_argc_max_to_callee_context(&mut self, argc_max: u16) {
        ...
        self.builder
            .ins()
            .stack_store(self.addr_type, argc_max, self.callee_context, OFFSET);
    }
    ...
    pub fn put_store_argv_to_callee_context(&mut self, argv: ArgvIr) {
        ...
        self.builder
            .ins()
            .stack_store(self.addr_type, argv.0, self.callee_context, OFFSET);
    }
    ...
    pub fn put_store_closure_to_callee_context(&mut self, closure: ClosureIr) {
        ...
        self.builder
            .ins()
            .stack_store(self.addr_type, closure.0, self.callee_context, OFFSET);
    }
    ...
    pub fn put_store_function_to_callee_context(&mut self, function: ObjectIr) {
        ...
        self.builder
            .ins()
            .stack_store(self.addr_type, function.0, self.callee_context, OFFSET);
    }
