    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match *self {
            ...
            Self::MissingAttributeValue =>
                write!(f, "missing-attribute-value"),
            Self::MissingDoctypeName =>
                write!(f, "missing-doctype-name"),
            ...
            Self::MissingWhitespaceBetweenDoctypePublicAndSystemIdentifiers =>
                write!(f, "missing-whitespace-between-doctype-public-and-system-identifiers"),
            Self::NestedComment =>
                write!(f, "nested-comment"),
            Self::NoncharacterCharacterReference =>
                write!(f, "noncharacter-character-reference"),
            Self::NoncharacterInInputStream =>
                write!(f, "noncharacter-in-input-stream"),
            Self::NonVoidHtmlElementStartTagWithTrailingSolidus =>
                write!(f, "non-void-html-element-start-tag-with-trailing-solidus"),
            Self::NullCharacterReference =>
                write!(f, "null-character-reference"),
            Self::SurrogateCharacterReference =>
                write!(f, "surrogate-character-reference"),
            Self::SurrogateInInputStream =>
                write!(f, "surrogate-in-input-stream"),
            ...
            Self::UnexpectedNullCharacter =>
                write!(f, "unexpected-null-character"),
            ...
            Self::UnexpectedSolidusInTag =>
                write!(f, "unexpected-solidus-in-tag"),
            Self::UnknownNamedCharacterReference =>
                write!(f, "unknown-named-character-reference"),
            Self::InsufficientInput =>
                write!(f, "insufficient-input"),
        }
    }
}
