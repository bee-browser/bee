...
void compiler_peer_declare_function(Compiler* self, uint32_t symbol_id, const char* name);
...
void compiler_peer_argument_list_head(Compiler* self);
void compiler_peer_argument_list_item(Compiler* self);
