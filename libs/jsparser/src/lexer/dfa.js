...
for (let state of states) {
  state.checkIdStart = state.labels.some((label) => label.startsWith('UnicodeIDStart -> . '));
  state.checkIdContinue = state.labels.some((label) =>
    label.startsWith('UnicodeIDContinue -> . ')
  );
