...
export * as csv from 'https://deno.land/std@0.109.0/encoding/csv.ts';
export * as fs from 'https://deno.land/std@0.109.0/fs/mod.ts';
export * as http from 'https://deno.land/std@0.109.0/http/mod.ts';
export * as http_file_server from 'https://deno.land/std@0.109.0/http/file_server.ts';
...
export * as testing from 'https://deno.land/std@0.109.0/testing/asserts.ts';
export * as textproto from 'https://deno.land/std@0.109.0/textproto/mod.ts';
export * as ws from 'https://deno.land/std@0.109.0/ws/mod.ts';
...
export * as servest from 'https://deno.land/x/servest@v1.3.4/mod.ts';
