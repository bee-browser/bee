...
export default class LayoutView extends Widget {
  constructor() {
    ...
    this.object_tree_.on(
      'mouseover', (object) => this.emit('target', object.id));
    this.object_tree_.on(
      'mouseout', (object) => this.emit('untarget', object.id));
    ...
    this.layer_tree_.on(
      'mouseover', (layer) => this.emit('target', layer.owner.id));
    this.layer_tree_.on(
      'mouseout', (layer) => this.emit('untarget', layer.owner.id));
  ...
  render() {
    this.elem_ =
      h('div', { id: 'layout-view' },
        h('div', { class: 'grid' },
          h('div', { id: 'layout-object-tree' },
            this.object_tree_.render()),
          h('div', { id: 'layout-layer-tree' },
            this.layer_tree_.render()),
