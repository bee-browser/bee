...
fn test_0032() {
    tokenize(
        r##"{"description":"A bogus comment stops at >, even if preceeded by two dashes","initialState":"Data","input":"<?foo-->","inputUtf16":[60,63,102,111,111,45,45,62],"output":[{"Comment":{"data":"?foo--"}}],"errors":[{"code":"unexpected-question-mark-instead-of-tag-name","location":{"line":1,"column":2}}]}"##,
    );
}
